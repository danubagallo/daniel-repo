...
public class WebServer {
    ...
    public static final String DOCUMENT_ROOT = "/Users/codecadet/Documents/daniel-gallo-repo/Exercises/ep-03-concurrency/web-server/www/";
        ...
        while (true) {
            ...
            try {
               ...
               // Thread clientThread = new Thread(clientDispatcher);
                //ExecutorService cachedPool = Executors.newCachedThreadPool();  -- cached
                ExecutorService singleExecutor = Executors.newSingleThreadExecutor();  // single

                singleExecutor.submit(clientDispatcher);
